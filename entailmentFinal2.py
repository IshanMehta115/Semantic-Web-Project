...
def subclassTransitivityIllustration(inputPath):
...
def subpropertyTransitivityIllustration(inputPath):
    #n = Namespace("http://iiitd.ac.in/course/sweb/project/")
    g = Graph()
    g.parse(inputPath)
    '''
...
subclassTransitivityIllustration("turtle1A.ttl")
print()
subpropertyTransitivityIllustration("turtle1B.ttl")
